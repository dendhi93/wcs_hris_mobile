    ...
    override fun onNavigationItemSelected(menuItem: MenuItem): Boolean {
        ...
        when (menuItem.itemId) {
            R.id.nav_dashboard -> {
                ...
                supportActionBar?.let { it.title = "Dashboard" }
            }
            R.id.nav_activity -> {
                vFragment = ActivityFragment()
                supportActionBar?.let { it.title = "Activity" }
            }
            R.id.nav_request -> {
                vFragment = RequestFragment()
                supportActionBar?.let { it.title = "Request" }
            }
            R.id.nav_approval -> {
                vFragment = ApprovalFragment()
                supportActionBar?.let { it.title = "Approval" }
            }
            ...
            R.id.nav_notification -> {
                ...
                supportActionBar?.let { it.title = "Notification" }
            }
            R.id.nav_team -> {
            ...
            R.id.nav_setting -> {
                ...
                supportActionBar?.let { it.title = "Setting" }
            }
            R.id.nav_logout -> {
